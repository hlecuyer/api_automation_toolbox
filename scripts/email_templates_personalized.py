...
"""
    ...
    "10 ans membres": {
        "subject": "La Coop des Communs a 10 ans, venez le 13 juin !",
        "attachments": ["🎉 INVITATION La Coop des Communs a 10 ans cette année.pdf"],
        "body_text": """{cher_chere} {prenom},

La Coop des Communs a dix ans cette année. Pour cet anniversaire, nous organisons un moment de convivialité et de célébration le samedi 13 juin prochain, de 11h30 à 16h, au Jardin d'agronomie tropicale de Paris.

Nos chemins se sont croisés tout au long de ces 10 années et nos échanges, notre compagnonnage, ont compté dans cette aventure.

Tu trouveras ci-joint le programme de la journée. Je serais, nous serions toutes et tous heureux de t'y accueillir et partager ce temps avec toi. Tu peux t'inscrire dès à présent à ce lien :
https://airtable.com/appTB6ISLjbexWWIM/shryuemN81hLf3srn
...
D'avance, je te remercie de ta réponse via le formulaire.
...
<head></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <p>{cher_chere} {prenom},</p>

    <p>La Coop des Communs a dix ans cette année. Pour cet anniversaire, nous organisons un moment de convivialité et de célébration le samedi 13 juin prochain, de 11h30 à 16h, au <strong>Jardin d'agronomie tropicale de Paris</strong>.</p>

    <p><strong>Nos chemins se sont croisés tout au long de ces 10 années et nos échanges, notre compagnonnage, ont compté dans cette aventure.</strong></p>

    <p>Tu trouveras ci-joint le programme de la journée. Je serais, nous serions toutes et tous heureux de t'y accueillir et <strong>partager ce temps avec toi.</strong> Tu peux t'inscrire dès à présent à ce lien :</p>
    ...
    <p>Plus, nous aimerions <strong>avoir ton témoignage,</strong> sur place si tu peux te joindre, sinon par vidéo, voire par écrit. En sus du plaisir du partage, nous ferons un récit, une base de connaissance de tout cela.</p>

    <p>Si tu as des photos, des documents écrits à partager, merci de les apporter.</p>

    <p>D'avance, je te remercie de ta réponse via le formulaire.</p>

    <p style="margin-top: 30px;">Bien à toi,</p>
